...
<svelte:head>
	...
	<meta name="description" content={t.contact_intro} />
	<link rel="canonical" href="https://neqrenewal.com/{lang}/contact" />
</svelte:head>
	...
	<section class="legal-content">
		<div class="container">
			...
			<div class="contact-info">
				{#each t.contact_info_text.split('\n') as line}
					{#if line}<p>{line}</p>{/if}
				{/each}
			</div>
		</div>
